...
INSERT INTO PHONE (PHONE_ID, COUNTRY_CODE, AREA_CODE, DIGITS, CREATE_DATE) VALUES (1, 1, 734, 2235209, now());

INSERT INTO USER (NAME, PROFILE_PICTURE, PW_HASH, EMAIL, BIO, EMAIL_VERIFIED_FLAG, PHONE_ID, CREATE_DATE, UPDATE_DATE)
VALUES ('JOHN DOE', 'johnDoe.png', '6b3a55e0261b0304143f805a24924d0c1c44524821305f31d9277843b8a10f4e
', 'johndoe@gmail.com','My Test bio', 'N', 1, now(), now());

select USER.*, P.*
from USER
join PHONE P on USER.PHONE_ID = P.PHONE_ID\G
